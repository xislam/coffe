# Generated by Django 3.1 on 2021-05-23 06:59
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='SportEvents',
            fields=[
                ('dailyevents_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='webapp.dailyevents')),
            ],
            options={
                'verbose_name': 'Sport Events',
                'verbose_name_plural': 'Sport Events',
            },
            bases=('webapp.dailyevents',),
        ),
        migrations.CreateModel(
            name='Menu',
            fields=[
